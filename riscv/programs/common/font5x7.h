...
/* Bitmap font 5×7 pixels, printable ASCII 32..126.
 * Each character: 5 bytes (5 columns), each byte = 7 bits (LSB=top row).
 * На 96×64 экране: 16 колонок × 8 строк текста (с 1px spacing = 6×8 cell).
 */

#define FONT5_W      5
#define FONT5_H      7
#define FONT5_CELL_W 6   /* 5 + 1px gap */
#define FONT5_CELL_H 8   /* 7 + 1px gap */
#define FONT5_COLS   16  /* 96 / 6 */
#define FONT5_ROWS   8   /* 64 / 8 */
#define FONT5_FIRST  32
#define FONT5_LAST   126

static const unsigned char font5x7[(FONT5_LAST - FONT5_FIRST + 1) * FONT5_W] = {
