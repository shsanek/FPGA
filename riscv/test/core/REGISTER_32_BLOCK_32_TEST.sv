module REGISTER_32_BLOCK_32_TEST();
    ...
    initial begin
        ...
        // T1: reset — все регистры обнуляются
        reset_trigger = 1;
        write_trigger = 0;
        rs1 = 5'd1; rs2 = 5'd2;
        rd  = 5'd0;
        ...
        // T4: два разных регистра одновременно
        rd = 5'd10;
        ...
        // T5: комбинационное чтение — смена rs1 без такта
        rs1 = 5'd3;
        #1;
        assert(rs1_value === 32'h12345678) else error = error + 1;
        rs1 = 5'd10;
